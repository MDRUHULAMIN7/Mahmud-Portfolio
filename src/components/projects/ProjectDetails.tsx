...
type SerializedProject = Omit<
  IProject,
  "createdAt" | "updatedAt" | "publishDate"
> & {
  _id?: string;
  createdAt: string;
  updatedAt: string;
...
export default function ProjectDetails({ project }: ProjectDetailsProps) {
  ...
  const embedUrl = useMemo(() => getYouTubeEmbedUrl(project.youtubeVideoLink), [project.youtubeVideoLink]);
        ...
        <div id="detail">
          <div className="pd-layout">
            ...
            <section className="pd-center">
              {embedUrl && (
                <div className="pd-shot pd-video">
                  <div className="pd-video-wrap">
                    <iframe
                      ...
                      allowFullScreen
                      loading="lazy"
                      onError={(e) => console.error('YouTube embed failed to load', e)}
                    />
                  </div>
                </div>
              )}
            ...
            <aside className="pd-right reveal-right visible">
              ...
              <div className="pd-meta-card">
                ...
                <a href="mailto:mdmahmud59yy@gmail.com">
                  mdmahmud59yy@gmail.com
                </a>
